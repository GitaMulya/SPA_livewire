...
<html lang="en">
  <head>
    ...
    <style>
      .gradient {
        background: linear-gradient(120deg, #36006c 8%, #9cc1f1 100%);
      }
    </style>
  </head>
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
      ...
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          ...
          <p class="leading-normal text-2xl mb-8">
           Sistem Informasi Manajemen Data Toko Buku "BookBase" Berbasis Website
          </p>
          <a id="navAction"
          class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-1 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
                href="{{ route('login') }}">
                Masuk
          </a>
        </div>
        ...
        <div class="w-full md:w-3/5 py-1 text-center">
          <img class="w-full md:w-4/5 z-50" src="media/this.png"/>
        </div>
      </div>
    </div>
    <div class="relative -mt-12 lg:-mt-24">
      <svg viewBox="0 0 1428 174" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          <g transform="translate(-2.000000, 44.000000)" fill="#ddbbff" fill-rule="nonzero">
          ...
          <g transform="translate(-4.000000, 76.000000)" fill="#ddbbff" fill-rule="nonzero">
            <path
    ...
    <!-- Change the colour #ddbbff to match the previous section colour -->
